...
class ShadowPyramidingTests(unittest.TestCase):
 def test_exact_matrix_and_combinations(self):
  ...
  self.assertEqual(r.dispatch_order,("permanent_control","fixed_25","dynamic_25","fixed_40","dynamic_40","fixed_60","dynamic_60","fixed_90","dynamic_90","pyramid_25","pyramid_40","pyramid_60","pyramid_90","dynamic_pyramid_25","dynamic_pyramid_40","dynamic_pyramid_60","dynamic_pyramid_90"))
