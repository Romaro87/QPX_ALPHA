...
The whole current file must be read through EOF after every individual user
prompt/message and before responding or acting. A summary, excerpt, cached
memory, preceding-prompt read, or truncated load is not compliance.
