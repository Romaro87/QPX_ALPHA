#!/usr/bin/env python3
"""Install, test, push, download, and run the first real QPX backtest — V2."""
...
BACKUP = ROOT / "backups" / "qpx_market_data_installer" / STAMP
...
PATCHES = {
    "qpx_bot/run_real_backtest.py": {
        '"qpx_version": "1.6.0"': '"qpx_version": "1.7.0"',
        "QPX BOT v1.6 — REAL HISTORICAL DATA RUNNER":
            "QPX BOT v1.7 — REAL HISTORICAL DATA RUNNER",
    },
    "tests/test_qpx_bot_real_data.py": {
        '"qpx_version": "1.6.0"':
            '"qpx_version": "1.7.0"',
    },
}
...
def commit_and_push() -> None:
    ...
    if staged.returncode == 0:
        print("Market-data acquisition code is already committed.")
        return
    ...
    run([
        ...
        "commit",
        "-m",
        "Implement QPX Bot automatic market data acquisition",
    ])
...
def main() -> int:
    print("=" * 76)
    print("QPX BOT — MARKET DATA ACQUISITION INSTALLER")
    print("=" * 76)
    ...
    print()
    print("Code tests passed and the acquisition milestone was pushed.")
    print("Starting the first real SPY + QDTE + VIX backtest...")
    print()
    ...
    try:
        ...
        print()
        print("=" * 76)
        print("QPX ACQUISITION CODE: INSTALLED AND PUSHED")
        print("LIVE PROVIDER DOWNLOAD: NEEDS RETRY")
        print("=" * 76)
        print(
            "The committed code and tests are safe. Re-run:\n"
            "python QPX_FETCH_AND_RUN_REAL_DATA.py --symbol SPY"
        )
        return 2
    ...
    print()
    print("=" * 76)
    print("QPX MARKET DATA + FIRST REAL BACKTEST: COMPLETE")
    print("=" * 76)
    return 0
