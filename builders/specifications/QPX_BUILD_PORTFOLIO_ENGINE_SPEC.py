...
"""
============================================================
QPX_BUILD_PORTFOLIO_ENGINE_SPEC.py
...
ROOT = Path("specifications") / "portfolio"
ROOT.mkdir(parents=True, exist_ok=True)

spec = """# Portfolio Engine Specification
...
(ROOT / "PORTFOLIO_ENGINE.md").write_text(spec, encoding="utf-8")

print("=" * 60)
print("PORTFOLIO ENGINE SPECIFICATION CREATED")
print("=" * 60)
print(ROOT.resolve())